...
> probe reads speech, not secrecy.** *(The paper counts those together as its **four nulls** — `K5`
> pre-committed the dropped gate as a reportable null, so both tallies are of the same ledger.)*
