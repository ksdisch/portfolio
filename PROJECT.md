...
3. Refresh `hush-gauge`'s card as each of M1–M3 decides (its M1 brief froze 2026-08-01; the M1 build session is next, and G1/G2 decide once). mute-map's S1/S2 stretches were declined for that repo and banked in the J-lens follow-on backlog.
