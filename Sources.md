...
| hush-gauge repo | https://github.com/ksdisch/hush-gauge | project repo | All hush-gauge card stats (M0/G0: dynamic-range PASS on all three scales; exposure-matched contrasts; gate definitions G1–G4) |
